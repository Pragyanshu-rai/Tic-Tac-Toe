...
class TTT extends JFrame implements ActionListener,WindowListener,MouseListener,Runnable
{
	...
	public void create()
	{
		...
		p2.addActionListener(e -> {//p2.setText(" "+p2.getText());
			if(st==-1)
			{
				...
				{
					JOptionPane.showMessageDialog(this,":D    "+p1.getText()+" you are 'X'.");
					pl1="X";
					pl2="O";
                    pn1 = "X-"+p1.getText()+":";
					p1.setText(pn1+0);
	...
	{	
		if(col==-1)
		{
			...
			int x=JOptionPane.showConfirmDialog(this,"           X-O Draw\n Wanna Play Again ;) ?","Tell me",JOptionPane.YES_NO_OPTION);
			if(x==JOptionPane.YES_OPTION)
				reset(true,0);
			else
				System.exit(0);
		...
		{
			reset(false,col);
		//	JOptionPane.showMessageDialog(this,"           "+w+" Wins :D");
			if(w.equals("X"))
			{
				if(opg==1)
				{
			...
			int x=JOptionPane.showConfirmDialog(this,"           "+w+" Wins :D\nWanna Play Again ;) ?","Tell me",JOptionPane.YES_NO_OPTION);
			if(x==JOptionPane.YES_OPTION)
				reset(true,0);
			else
				System.exit(0);
